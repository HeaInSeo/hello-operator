...
type HelloStatus struct {
	...
	// conditions represent the current state of the Hello resource.
...
type Hello struct {
	...
	// spec defines the desired state of Hello
	// +required
	Spec HelloSpec `json:"spec"`

	// status defines the observed state of Hello
	// +optional
	Status HelloStatus `json:"status,omitzero"`
}
