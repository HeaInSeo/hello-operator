...
```sh
make build-installer IMG=<some-registry>/hello-operator:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/hello-operator/<tag or branch>/dist/install.yaml
```
